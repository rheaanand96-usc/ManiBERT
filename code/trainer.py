        ...
        for epoch in range(start_epoch, self.max_epoch):
            ...
            while step < self.num_batches:
                ...
                if cfg.TEXT_ENCODER == 'RNN':
                    ...
                    words_embs, sent_emb = text_encoder.get_embeddings(captions)
                    w_words_embs, w_sent_emb = text_encoder.get_embeddings(wrong_caps)
            ...
            for _ in range(5):  # (cfg.TEXT.CAPTIONS_PER_IMAGE):
                for step, data in enumerate(self.data_loader, 0):
                    ...
                    if cfg.TEXT_ENCODER == 'RNN':
                        ...
                        words_embs, sent_emb = text_encoder.get_embeddings(wrong_caps)
